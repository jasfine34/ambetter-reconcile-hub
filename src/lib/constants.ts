...
export const ISSUE_TYPE_LABELS: Record<IssueType, string> = {
  'Missing from Back Office': 'Missing from Back Office',
...
export const EBU_BATCH_SCOPE_DISCLAIMER =
  "Unpaid counts now reflect cross-batch payment clearings where available. Last sweep: see the Dashboard timestamp. Re-run cross-batch clearings after rebuilding any batch.";
