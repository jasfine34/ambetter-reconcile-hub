      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <MetricCard title="Expected Enrollments" value={metrics.expected} icon={<Users className="h-4 w-4" />} onClick={() => setDrilldown('expected')} tooltip={{ text: "These are the Ambetter members we believe should exist based on our enrollment system (EDE), after filtering for active policies starting 1/1/2026. Counts subscribers (one per EDE record).", why: "This is your baseline. All other numbers are measured against this to determine if anything is missing or incorrect." }} />
