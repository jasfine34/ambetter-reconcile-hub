...
// The gated live-denominator smoke lives in its own file
// (src/test/blocker-facts-c1a-denominator.smoke.test.ts) so it isn't
// contaminated by the vi.doMock('@/integrations/supabase/client') used
// by the purity test above, and so it can carry its own generous timeout.
